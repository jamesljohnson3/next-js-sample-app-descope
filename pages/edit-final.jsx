...
export default function App() {
  ...
  const handleFormSubmit = async (e) => {
    ...
    try {
      ...
      if (response.ok) {
        ...
        setTimeout(() => {
          ...
          router.push('/testui-final'); // Replace '/error-page' with the appropriate URL of the error page
        }, 7000);
      } else {
        // Handle API errors
    ...
    showSnackbar({
      title: "Collection updated successfully! You'll be redirected.",
      status: 'success',
    });
  };
      ...
      {(user) => {
        if (user && user.unsafeMetadata && user.unsafeMetadata.galleryImgs) {
          ...
          return (
            ...
            {galleryImgs[0].galleryImg.map((item) => (
                <li key={item.id}>
                <a href="https://connect.unlimitpotential.com/">  <img
                    src={item.url}
                    alt={item.title}
                    width={150}
                    height={150}
          ...
          <div className="col-span-4">
                  ...
                  <div className="mt-1">
                    <input
                      type="text"
                      id="name"
placeholder='Single Field or Multiple fields'
                      onChange={(e) =>
